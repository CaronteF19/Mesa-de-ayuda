...
class PluginFieldsContainerDisplayCondition extends CommonDBChild
{
    ...
    /**
     * Busca en $fields un valor cuyo key sea similar a $linkfield (p. ej. plugin_fields_proposito_sgcdropdowns_id
     * vs plugin_fields_propsitosgcfielddropdowns_id) para resolver diferencias de nombre entre condición y BD/form.
     *
     * @param array  $fields    Array clave => valor
     * @param string $linkfield Nombre esperado del campo (p. ej. plugin_fields_xxxdropdowns_id)
    ...
    public function checkCondition($item)
    {
        ...
        // Si no se encuentra por clave exacta (p. ej. nombre distinto en BD), buscar clave similar para campos plugin
